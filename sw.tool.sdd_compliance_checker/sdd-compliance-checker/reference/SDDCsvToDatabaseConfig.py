...
db_server_name = "frdb120.cw01.contiwan.com:60120"
db_name = "ICAS_DevOps_1"

# Mapping DB Columns(Keys) with CSV Columns(Values)
db_Columns_Map = {
...
#           db_columns : Mention the DB Columns in which you want to insert data. E.g. [Repo_Name], [Project_ID]
#           db_values  : Mention the DB Values for above mentioned columns.       E.g. '{csv_row[Repo_Name]}', {projectTable_projectID}
...
db_Tables = {
    ...
    'sdd_compliance_checker_info' : 
    {
        ...
        'insert' : 
        {
            'db_columns' :"[script_execution_time],[artifactory_upload_time],[type_id],[sw_component_id],[branch_id],[version_id],[brief_nmb_elements],[brief_nmb_not_covered],[brief_nmb_covered],[brief_pct_coverage],[enum_vars_brief_nmb_elements],[enum_vars_brief_nmb_not_covered],[enum_vars_brief_nmb_covered],[enum_vars_brief_pct_coverage],[param_nmb_elements],[param_nmb_not_covered],[param_nmb_covered],[param_pct_coverage],[return_nmb_elements],[return_nmb_not_covered],[return_nmb_covered],[return_pct_coverage],[security_nmb_elements],[security_nmb_not_covered],[security_nmb_covered],[security_pct_coverage],[verification_criteria_nmb_elements],[verification_criteria_nmb_not_covered],[verification_criteria_pct_coverage],[test_nmb_elements],[test_nmb_not_covered],[test_nmb_covered],[test_pct_coverage],[sdd_trace_nmb_elements],[sdd_trace_nmb_not_covered],[sdd_trace_nmb_covered],[sdd_trace_pct_coverage],[sdd_trace_details_nmb_fcts],[sdd_trace_details_nmb_dds_fct],[sdd_trace_details_pct_dd_fct],[sdd_trace_details_nmb_req_fct],[sdd_trace_details_pct_req_fct],[sdd_trace_details_nmb_linked_req_fcts],[sdd_trace_details_nmb_linked_req_page],[sdd_linked_req_ids_nmb],[verification_criteria_nmb_covered],[compliance_report]",
            'db_values' : "'{csv_row[script_execution_time]}','{csv_row[artifactory_upload_time]}',{type_id},{sw_component_id},{branch_id},{version_id},'{csv_row[brief_nmb_elements]}','{csv_row[brief_nmb_not_covered]}','{csv_row[brief_nmb_covered]}','{csv_row[brief_pct_coverage]}','{csv_row[enum_vars_brief_nmb_elements]}','{csv_row[enum_vars_brief_nmb_not_covered]}','{csv_row[enum_vars_brief_nmb_covered]}','{csv_row[enum_vars_brief_pct_coverage]}','{csv_row[param_nmb_elements]}','{csv_row[param_nmb_not_covered]}','{csv_row[param_nmb_covered]}','{csv_row[param_pct_coverage]}','{csv_row[return_nmb_elements]}','{csv_row[return_nmb_not_covered]}','{csv_row[return_nmb_covered]}','{csv_row[return_pct_coverage]}','{csv_row[security_nmb_elements]}','{csv_row[security_nmb_not_covered]}','{csv_row[security_nmb_covered]}','{csv_row[security_pct_coverage]}','{csv_row[verification_criteria_nmb_elements]}','{csv_row[verification_criteria_nmb_not_covered]}','{csv_row[verification_criteria_pct_coverage]}','{csv_row[test_nmb_elements]}','{csv_row[test_nmb_not_covered]}','{csv_row[test_nmb_covered]}','{csv_row[test_pct_coverage]}','{csv_row[sdd_trace_nmb_elements]}','{csv_row[sdd_trace_nmb_not_covered]}','{csv_row[sdd_trace_nmb_covered]}','{csv_row[sdd_trace_pct_coverage]}','{csv_row[sdd_trace_details_nmb_fcts]}','{csv_row[sdd_trace_details_nmb_dds_fct]}','{csv_row[sdd_trace_details_pct_dd_fct]}','{csv_row[sdd_trace_details_nmb_req_fct]}','{csv_row[sdd_trace_details_pct_req_fct]}','{csv_row[sdd_trace_details_nmb_linked_req_fcts]}','{csv_row[sdd_trace_details_nmb_linked_req_page]}','{csv_row[sdd_linked_req_ids_nmb]}','{csv_row[verification_criteria_nmb_covered]}','{csv_row[compliance_report]}'"
        },
        'update' : 
        {
           'data':"[script_execution_time]='{csv_row[script_execution_time]}',[artifactory_upload_time]='{csv_row[artifactory_upload_time]}',[type_id]={type_id},[sw_component_id]={sw_component_id},[branch_id]={branch_id},[version_id]={version_id},[brief_nmb_elements]='{csv_row[brief_nmb_elements]}',[brief_nmb_not_covered]='{csv_row[brief_nmb_not_covered]}',[brief_nmb_covered]='{csv_row[brief_nmb_covered]}',[brief_pct_coverage]='{csv_row[brief_pct_coverage]}',[enum_vars_brief_nmb_elements]='{csv_row[enum_vars_brief_nmb_elements]}',[enum_vars_brief_nmb_not_covered]='{csv_row[enum_vars_brief_nmb_not_covered]}',[enum_vars_brief_nmb_covered]='{csv_row[enum_vars_brief_nmb_covered]}',[enum_vars_brief_pct_coverage]='{csv_row[enum_vars_brief_pct_coverage]}',[param_nmb_elements]='{csv_row[param_nmb_elements]}',[param_nmb_not_covered]='{csv_row[param_nmb_not_covered]}',[param_nmb_covered]='{csv_row[param_nmb_covered]}',[param_pct_coverage]='{csv_row[param_pct_coverage]}',[return_nmb_elements]='{csv_row[return_nmb_elements]}',[return_nmb_not_covered]='{csv_row[return_nmb_not_covered]}',[return_nmb_covered]='{csv_row[return_nmb_covered]}',[return_pct_coverage]='{csv_row[return_pct_coverage]}',[security_nmb_elements]='{csv_row[security_nmb_elements]}',[security_nmb_not_covered]='{csv_row[security_nmb_not_covered]}',[security_nmb_covered]='{csv_row[security_nmb_covered]}',[security_pct_coverage]='{csv_row[security_pct_coverage]}',[verification_criteria_nmb_elements]='{csv_row[verification_criteria_nmb_elements]}',[verification_criteria_nmb_not_covered]='{csv_row[verification_criteria_nmb_not_covered]}',[verification_criteria_pct_coverage]='{csv_row[verification_criteria_pct_coverage]}',[test_nmb_elements]='{csv_row[test_nmb_elements]}',[test_nmb_not_covered]='{csv_row[test_nmb_not_covered]}',[test_nmb_covered]='{csv_row[test_nmb_covered]}',[test_pct_coverage]='{csv_row[test_pct_coverage]}',[sdd_trace_nmb_elements]='{csv_row[sdd_trace_nmb_elements]}',[sdd_trace_nmb_not_covered]='{csv_row[sdd_trace_nmb_not_covered]}',[sdd_trace_nmb_covered]='{csv_row[sdd_trace_nmb_covered]}',[sdd_trace_pct_coverage]='{csv_row[sdd_trace_pct_coverage]}',[sdd_trace_details_nmb_fcts]='{csv_row[sdd_trace_details_nmb_fcts]}',[sdd_trace_details_nmb_dds_fct]='{csv_row[sdd_trace_details_nmb_dds_fct]}',[sdd_trace_details_pct_dd_fct]='{csv_row[sdd_trace_details_pct_dd_fct]}',[sdd_trace_details_nmb_req_fct]='{csv_row[sdd_trace_details_nmb_req_fct]}',[sdd_trace_details_pct_req_fct]='{csv_row[sdd_trace_details_pct_req_fct]}',[sdd_trace_details_nmb_linked_req_fcts]='{csv_row[sdd_trace_details_nmb_linked_req_fcts]}',[sdd_trace_details_nmb_linked_req_page]='{csv_row[sdd_trace_details_nmb_linked_req_page]}',[sdd_linked_req_ids_nmb]='{csv_row[sdd_linked_req_ids_nmb]}',[verification_criteria_nmb_covered]='{csv_row[verification_criteria_nmb_covered]}',[compliance_report]='{csv_row[compliance_report]}'"
